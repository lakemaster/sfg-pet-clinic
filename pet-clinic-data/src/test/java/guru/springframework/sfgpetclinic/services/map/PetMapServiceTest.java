...
class PetMapServiceTest {
    ...
    void setUp() {
        ...
        petMapService = new PetServiceMap(new PetTypeMapService());

        petMapService.save(Pet.builder().id(petId).petType(PetType.builder().name("Cat").build()).build());
    }
    ...
    void saveExistingId() {
        ...
        Pet pet2 = Pet.builder().id(id).petType(PetType.builder().name("Dog").build()).build();
    ...
    void saveNoId() {
        ...
        Pet savedPet = petMapService.save(Pet.builder().id(2L).petType(PetType.builder().name("Dog").build()).build());
